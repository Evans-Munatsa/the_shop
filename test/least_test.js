...
var least = require('../scripts/least');
...
describe('least popular product for each week', function() {
    it('week1 product', function() {
        var result = least.least(week1)
